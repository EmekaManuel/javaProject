...
public class Main {
    ...
    static class consoleColors {
        public static String red = Game.showColor ? "\033[1;31m" : "";
        public static String green = Game.showColor ? "\033[1;32m" : "";
        public static String reset = Game.showColor ? "\033[1;0m" : "";
    }
    
    public static void main(String[] args) {
        System.out.println(System.console());
        System.out.println(System.getenv("VSCODE_PID"));
        Game game = new Game();
